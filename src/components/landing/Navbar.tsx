  ...
  return (
    <header
      ...
      style={{
        ...
        zIndex: 100,
        background: scrolled
          ? isDark ? 'rgba(15,20,38,0.92)' : 'rgba(255,255,255,0.92)'
          : mobileOpen
          ? 'var(--brand-navy)'
          : 'transparent',
    ...
    >
      <div style={{
        ...
        <a href="#" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none', flexShrink: 0 }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 16, color: onDark ? '#fff' : 'var(--ink)', transition: 'color 0.25s', }}>
            SansMail
          </span>
        </a>
        ...
        {isMobile && (
          <button
            ...
            style={{
              ...
              borderRadius: 6, transition: 'color 0.25s',
            }}
          >
            ...
            <div style={{ padding: '8px 24px 24px' }}>
              {navLinks.map((l, i) => (
                <motion.a
                  ...
                  style={{
                    display: 'flex', padding: '13px 0', fontSize: 15, fontWeight: 500,
              ...
              >
                ...
                <Link
                  ...
                  onClick={() => setMobileOpen(false)}
                  style={{
                    padding: '11px 16px', borderRadius: 8, fontSize: 14, fontWeight: 500,
                    textAlign: 'center', color: 'rgba(255,255,255,0.85)', textDecoration: 'none',

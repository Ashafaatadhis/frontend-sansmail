...
export const features: Feature[] = [
  ...
  { title: 'Auto-Expire 1 Jam', desc: 'Email otomatis terhapus setelah 60 menit. Privasi terjaga tanpa hapus manual.', icon: Clock, tint: 'var(--card-tint-sky)' },
...
export const stats = [
  ...
  { value: '60 menit', label: 'Masa aktif email' },
...
export const faqs = [
  ...
  { q: 'Berapa lama email disimpan?', a: 'Email disimpan selama 60 menit (1 jam) sejak masuk ke inbox. Setelah itu otomatis terhapus dari server. Tidak perlu hapus manual.' },
  ...
  { q: 'Apakah license berlaku selamanya?', a: 'Ya, license bersifat lifetime. Bayar sekali, aktif selamanya tanpa biaya langganan bulanan.' },

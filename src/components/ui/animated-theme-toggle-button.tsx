...
export const AnimatedThemeToggleButton = ({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex items-center justify-center p-1.5 rounded-full outline-none focus:outline-none active:outline-none focus:ring-0 cursor-pointer border transition-colors",
        darkMode ? "bg-surface border-hairline" : "bg-canvas border-hairline",
        className
      )}
